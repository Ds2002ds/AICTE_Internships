...
# === Load model ===
model = joblib.load('/home/ds/Downloads/forecasting_ev_model.pkl')
...
# Image
st.image("/home/ds/Downloads/ev-car-factory.jpg", use_container_width=True)
...
@st.cache_data
def load_data():
    df = pd.read_csv("/home/ds/Downloads/preprocessed_ev_data.csv")
